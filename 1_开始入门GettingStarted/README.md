...
设置不同的TARGET_DEVICE，改变内核代码的运行设备。
Set a different TARGET_DEVICE to change the device on which the kernel code runs.
-------------------------------------------------------------
cmake .. -DTARGET_DEVICE=CPU && make && ../bin/./main
*************************device info************************  
设备类型: CPU  
设备名称：Intel(R) Core(TM) i5-14600KF  
最大工作小组大小:8192  
全局内存大小: 31.1711 Gbytes  
最大计算单元数量: 20  
*************************************************************
-------------------------------------------------------------
